...
#ifndef RONA_REBUILD_SWIFT_H
#define RONA_REBUILD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RONA_Rebuild",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12RONA_Rebuild26AVCaptureScanCameraService")
@interface AVCaptureScanCameraService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVCaptureOutput;
@class AVCaptureConnection;
@interface AVCaptureScanCameraService (SWIFT_EXTENSION(RONA_Rebuild)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class NSCoder;
/// Container view that correctly sizes the preview layer on every layout pass.
SWIFT_CLASS("_TtC12RONA_Rebuild20PreviewContainerView")
